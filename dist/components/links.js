...
import { link_names } from "../services/paths.js";
...
for (let i = 0; i < links_number; i++) {
    let element = create("a", ["button", "button_link", "nav_link", "is_flx", "has_x_cntr", "has_y_cntr"], `${names[i][0].toUpperCase() + names[i].substring(1)}`);
