...
import { CARD_IMAGE_PATH as path } from "../utils/paths.js";
console.log(path);
const p = __dirname;
console.log(p);
const articles_message = create("div", ["is_flx_cl", "has_x_end"], create("h2", ["section_title", "is_flx"], "Latest Articles"));
...
for (let i = 1; i <= cards_number; i++) {
    ...
    card_image.alt = `${card_images[i - 1][0].toUpperCase() + card_images[i - 1].substring(1)}'s image`;
    ...
    let card_content = create("div", ["card-article_content", "is_flx", "has_x_cntr", "has_y_cntr"], create("div", ["card-article_content_cntr", "is_flx_cl", "has_x_spcd"]));
